...
export function KpiGrid() {
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-3">
      <MetricCard label="Total monitors" value={total} icon={<Icon name="activity" width={15} height={15} />} loading={lb} hint={stats?.uptime30d != null ? `${stats.uptime30d}% uptime · 30d` : "No uptime data yet"} />
